...
class TranscriptionOrchestrator:
    def __init__(self, config: TranscriptionConfig, output_path: str):
        ...
        self._audio_capture = AudioCapture(config.sample_rate, device_index=config.microphone_index)
    ...
    def start(self) -> None:
        ...
        self._thread = threading.Thread(target=self._process_loop, name="Orchestrator - _process_loop")
        self._thread.start()
